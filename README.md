...
- [OpenCouncil](https://github.com/schemalabz/opencouncil) — open-source platform that transcribes, summarizes, and makes searchable municipal council meetings using AI-generated speaker recognition and subject categorization, built by the Schema Labs democracy nonprofit. `[uses-ai]` `[GR]`
